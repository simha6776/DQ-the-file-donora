...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002218657193').split() if id_pattern.search(auth_channel)]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://narasimhamurthyht9:aIxFw22N5brWKpIL@cluster0.l8io8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
IS_VERIFY = is_enabled((environ.get('IS_VERIFY', 'False')), False)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "-1002223598553")
VERIFY2_URL = environ.get('VERIFY2_URL', "seturl.in")
VERIFY2_API = environ.get('VERIFY2_API', "3e2c0a75d062e5bb8976ddd106824d49a7b7ecf4")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'kingurl.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '657ced1786debc6cd957fa3f26d9369cd6a066ba')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@NM_channel_bot')
